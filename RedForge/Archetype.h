...
//class Archetype : public System<Components...>
//{
//protected:
...
//
//public:
//	virtual Entity ConstructEntity(const Entity& parent, LevelID level = INVALID_LEVEL)
//	{
//		if(parent.IsValid())
//			return EntityManager::CreateEntity<Components...>(parent, "");
//		else
//			return EntityManager::CreateEntity<Components...>("", level);
//	}
//
//protected:
...
//
//		world->GetEntityManager().ForEachComponentOfType<Components...>(&T::InitializeEntity);
//	}
//	void Shutdown(const EngineShutdownParams& params, World& world) override
//	{
//		
//	}
//	void Update(SystemContext<Components...>& ctx, float deltaTime) override
//	{
//		ctx.ForEachComponentOfType<Components...>(&T::UpdateEntity);
//		
...
//	virtual Entity ConstructEntity(const Entity& parent, LevelID level = INVALID_LEVEL) override
//	{
