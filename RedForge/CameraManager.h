...
public:
	...
	static REDFORGE_API void SetViewMatrixOverride(glm::mat4* viewMatrix) { Instance->viewMatrixOverride = viewMatrix; };
	static REDFORGE_API void SetProjectionMatrixOverride(glm::mat4* projectionMatrix) { Instance->projectionMatrixOverride = projectionMatrix; };
